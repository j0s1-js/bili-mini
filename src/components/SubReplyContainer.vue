<template>
    <div class="sub-reply-container">
        <div class="sub-reply-item" v-for="n in 2" :key="n">
            <div class="sub-user-info">
                <div class="sub-reply-avatar">
                    <el-avatar class="bili-avatar" style="width: 24px; height:24px"
            ...
            <div class="sub-reply-info">
                <span class="sub-reply-time">2024-02-18 16:09</span>
                <span class="sub-reply-like">
                    <i class="svg-icon">
                        <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="200"
                            height="200">
                            <path
        ...
        <div class="view-more">
            ...
            <div class="view-more-pagination"></div>
        </div>
    </div>
</template>
